<template>
  <div class="w-20 bg-gray-300/40 flex-shrink-0 flex flex-col items-center pt-2 border-r border-gray-300/70">
    <RouterLink to="/mailbox">
      <div :class="navClass('/mailbox')">
        <div class="w-16 h-10 flex justify-center items-center">
          <svg class="w-10 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
        ...
        <div class="text-xs uppercase font-semibold text-center select-none">Mailbox</div>
      </div>
    </RouterLink>
    ...
    <RouterLink to="/settings">
      <div :class="navClass('/settings')">
        <div class="w-16 h-10 flex justify-center items-center">
          <svg class="w-10 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
            <path class="opacity-40" d="M638.41 387a12.34 12.34 0 0 0-12.2-10.3h-16.5a86.33 86.33 0 0 0-15.9-27.4L602 335a12.42 12.42 0 0 0-2.8-15.7 110.5 110.5 0 0 0-32.1-18.6 12.36 12.36 0 0 0-15.1 5.4l-8.2 14.3a88.86 88.86 0 0 0-31.7 0l-8.2-14.3a12.36 12.36 0 0 0-15.1-5.4 111.83 111.83 0 0 0-32.1 18.6 12.3 12.3 0 0 0-2.8 15.7l8.2 14.3a86.33 86.33 0 0 0-15.9 27.4h-16.5a12.43 12.43 0 0 0-12.2 10.4 112.66 112.66 0 0 0 0 37.1 12.34 12.34 0 0 0 12.2 10.3h16.5a86.33 86.33 0 0 0 15.9 27.4l-8.2 14.3a12.42 12.42 0 0 0 2.8 15.7 110.5 110.5 0 0 0 32.1 18.6 12.36 12.36 0 0 0 15.1-5.4l8.2-14.3a88.86 88.86 0 0 0 31.7 0l8.2 14.3a12.36 12.36 0 0 0 15.1 5.4 111.83 111.83 0 0 0 32.1-18.6 12.3 12.3 0 0 0-2.8-15.7l-8.2-14.3a86.33 86.33 0 0 0-15.9-27.4h16.5a12.43 12.43 0 0 0 12.2-10.4 112.66 112.66 0 0 0 .01-37.1zm-136.8 44.9c-29.6-38.5 14.3-82.4 52.8-52.8 29.59 38.49-14.3 82.39-52.8 52.79zm136.8-343.8a12.34 12.34 0 0 0-12.2-10.3h-16.5a86.33 86.33 0 0 0-15.9-27.4l8.2-14.3a12.42 12.42 0 0 0-2.8-15.7 110.5 110.5 0 0 0-32.1-18.6A12.36 12.36 0 0 0 552 7.19l-8.2 14.3a88.86 88.86 0 0 0-31.7 0l-8.2-14.3a12.36 12.36 0 0 0-15.1-5.4 111.83 111.83 0 0 0-32.1 18.6 12.3 12.3 0 0 0-2.8 15.7l8.2 14.3a86.33 86.33 0 0 0-15.9 27.4h-16.5a12.43 12.43 0 0 0-12.2 10.4 112.66 112.66 0 0 0 0 37.1 12.34 12.34 0 0 0 12.2 10.3h16.5a86.33 86.33 0 0 0 15.9 27.4l-8.2 14.3a12.42 12.42 0 0 0 2.8 15.7 110.5 110.5 0 0 0 32.1 18.6 12.36 12.36 0 0 0 15.1-5.4l8.2-14.3a88.86 88.86 0 0 0 31.7 0l8.2 14.3a12.36 12.36 0 0 0 15.1 5.4 111.83 111.83 0 0 0 32.1-18.6 12.3 12.3 0 0 0-2.8-15.7l-8.2-14.3a86.33 86.33 0 0 0-15.9-27.4h16.5a12.43 12.43 0 0 0 12.2-10.4 112.66 112.66 0 0 0 .01-37.1zm-136.8 45c-29.6-38.5 14.3-82.5 52.8-52.8 29.59 38.49-14.3 82.39-52.8 52.79z"/>
        ...
        <div class="text-xs uppercase font-semibold text-center select-none">Settings</div>
      </div>
    </RouterLink>
  </div>
</template>
...
function navClass(path) {
  return `relative mb-4 py-1 cursor-pointer hover:opacity-90 rounded ${route.path === path ? 'text-gray-100 bg-gray-700 shadow-inner' : 'text-gray-600'}`;
}
</script>
